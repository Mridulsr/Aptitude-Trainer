    ...
    "questions": [
      {
        ...
        "options": ["1", "2", "3", "4"],
        "answer": "3",
        "explanation": "2^1=2, 2^2=4, 2^3=8, 2^4=16. The units digit repeats every 4 powers (2, 4, 8, 6). 31 divided by 4 leaves remainder 3. 2^3 = 8. 8 divided by 5 leaves a remainder of 3."
      },
      {
        "id": 2,
        "topic": "Profit & Loss",
        "question": "A man buys a cycle for 1400 and sells it at a loss of 15%. What is the selling price?",
        "options": ["1190", "1200", "1100", "1160"],
        "answer": "1190",
      ...
      },
      {
        "id": 3,
        "topic": "Time & Work",
        "question": "A can do a piece of work in 8 days and B can do it in 10 days. How long will they take together?",
        "options": ["40/9 days", "4 days", "5 days", "4.5 days"],
        "answer": "40/9 days",
        "explanation": "(1/8 + 1/10) = 9/40 per day. Total time = 40/9 days."
      },
      {
        "id": 4,
        "topic": "Averages",
      ...
      },
      {
        ...
        "options": ["20%", "25%", "15%", "30%"],
        "answer": "25%",
        "explanation": "Using formula [r/(100-r)] * 100: (20/80) * 100 = 25%."
      },
      {
        "id": 6,
        "topic": "Series",
        ...
        "options": ["7", "10", "12", "13"],
        "answer": "10",
        "explanation": "Alternating pattern: +3, -2, +3, -2, +3... 12 - 2 = 10."
      },
      {
        "id": 7,
        "topic": "Probability",
        ...
        "answer": "10/21",
        "explanation": "Total ways: 7C2 = 21. Ways to pick non-blue (Red/Green): 5C2 = 10. Prob = 10/21."
      },
      {
        "id": 8,
        "topic": "Data Interpretation",
        "question": "In a pie chart, a value of 25% is represented by how many degrees?",
        "options": ["45°", "90°", "120°", "180°"],
        "answer": "90°",
        "explanation": "0.25 * 360 = 90 degrees."
      },
      {
        "id": 9,
        "topic": "Equations",
        "question": "The sum of two numbers is 25 and their difference is 13. Find the product.",
        "options": ["104", "114", "315", "325"],
        "answer": "114",
        "explanation": "x+y=25, x-y=13 yields x=19, y=6. Product 19 * 6 = 114."
      },
      {
        "id": 10,
        "topic": "HCF/LCM",
    ...
    "questions":
      {
        "id": 1,
        "topic": "Ages",
        "question": "A father is twice as old as his son. 20 years ago, the father was 12 times as old as the son. Current age of father?",
        "options": ["44", "32", "22", "45"],
        "answer": "44",
        "explanation": "F=2S; (F-20)=12(S-20). Solving gives S=22, F=44."
      },
      {
        "id": 2,
        "topic": "Time & Distance",
  ...
  }
      {
        ...
        "options": ["EDRIRL", "DCQHQK", "EOBDMF", "FMCTMB"],
        "answer": "EDRIRL",
        "explanation": "Pattern: +2, +3, +4, +5, +6, +7 shift for each letter."
      },
      {
        "id": 4,
        "topic": "Simple Interest",
        "question": "How much time will it take for a sum of money to double at 5% SI per annum?",
        "options": ["10 yrs", "15 yrs", "20 yrs", "25 yrs"],
        "answer": "20 yrs",
        "explanation": "SI=P. P = (P * 5 * T)/100 yields T = 20."
      },
      {
        "id": 5,
        "topic": "Data Interpretation",
        "question": "In a class of 50 students, 30 like Math, 25 like Science, and 10 like both. How many like neither?",
        "options": ["5", "10", "15", "20"],
        "answer": "5",
        "explanation": "Total = (Math + Sci - Both) + Neither. 50 = (30+25-10) + N, so N=5."
      },
      {
        "id": 6,
        "topic": "Ratios",
        "question": "If A:B = 2:3 and B:C = 4:5, then C:A is:",
        "options": ["15:8", "8:15", "3:2", "5:4"],
        "answer": "15:8",
        "explanation": "A/C = (A/B) * (B/C) = 8/15. Therefore C:A = 15:8."
      },
      {
        "id": 7,
        "topic": "Simplification",
        ...
        "options": ["0.06", "0.006", "0.0006", "0.00006"],
        "answer": "0.00006",
        "explanation": "3 * 2 = 6. Total decimal places = 3 + 2 = 5."
      },
      {
        "id": 8,
        ...
        "answer": "His son's",
        "explanation": "'My father's son' is the man himself. So, the man in the photo's father is the speaker."
      },
      {
        "id": 9,
        "topic": "Mensuration",
        "question": "If the side of a square is increased by 25%, its area increases by:",
        "options": ["25%", "50%", "56.25%", "62.5%"],
        "answer": "56.25%",
        "explanation": "(1.25)^2 = 1.5625. Area increase = 56.25%."
      },
      {
        "id": 10,
        "topic": "Number Series",
